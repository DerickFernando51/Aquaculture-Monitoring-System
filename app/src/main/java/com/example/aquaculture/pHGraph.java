...
public class pHGraph extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pHBackBtn= findViewById(R.id.pH_btn);
        mLineChart = findViewById(R.id.pH_chart);
        mLineChart.setDragEnabled(true);
        mLineChart.setScaleEnabled(true);

        pHBackBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                Intent ValuesIntent = new Intent( pHGraph.this,  MainActivity.class);
        ...
        leftAxis.setAxisMaximum(14f); // Set Y axis max value
        ...
        mDatabaseRef = FirebaseDatabase.getInstance().getReference().child("pH");
        ...
        mDatabaseRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot dataSnapshot : snapshot.getChildren()) {
                    ...
                    if (timeValue != null) { // check if value is not null before calling its methods
                        Log.d("TAG", timeValue.toString());
                    }
