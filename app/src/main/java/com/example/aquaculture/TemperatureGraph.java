...
public class TemperatureGraph extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TempBackBtn= findViewById(R.id.temp_btn);
        mLineChart = findViewById(R.id.temperature_chart);
        ...
        TempBackBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent ValuesIntent = new Intent(TemperatureGraph.this,  MainActivity.class);
        ...
        leftAxis.setAxisMaximum(100f); // Set Y axis max value
